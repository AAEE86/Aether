...
use crate::orchestration::{
    codex_cyber_flag_passthrough_enabled, codex_responses_websocket_enabled,
};
...
pub(crate) fn build_admin_provider_summary_value(
    ...
    json!({
        ...
        "codex_responses_websocket_enabled": codex_responses_websocket_enabled(&provider.provider_type, provider.config.as_ref()),
