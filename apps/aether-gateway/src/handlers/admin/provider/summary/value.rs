...
use crate::orchestration::{codex_cyber_flag_passthrough_enabled, responses_websocket_capability};
...
pub(crate) fn build_admin_provider_summary_value(
    ...
    json!({
        ...
        "responses_websocket_enabled": responses_websocket_capability(&provider.provider_type, provider.config.as_ref()).is_some(),
